                    ...
                    <div key={index} className="HomeScrollBox">
                        <div className="PostHeader  mt-1">
                            <div className="p-2 d-flex justify-content-center align-items-center ">
                                <div>
                                    <img style={{ cursor: "pointer" }} onClick={() => { viewFreindProfile(posts.userId._id) }} src={posts.userId.profilePhoto ? api.profilepic + posts.userId.profilePhoto : avtar} className="PostHeaderProfile ms-2" />
                                </div>
                                <div>
                                        ...
                                        <div className="menu">
                                            <div>
                                                <ul>
                                                    ...
                                                    <li><a onClick={() => spamHandle(posts._id)} style={{ cursor: "pointer" }} className="link">Report</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
